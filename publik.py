...
Bots=[mid]
owner=["u78643d09e42a36836a17cc918963a8b7",mid]
admin=["u78643d09e42a36836a17cc918963a8b7",mid]
baby=["u391ab5a729c91215056e2b7d6c6ff0b2"]#chery/barby/ranita
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""👉✯✰тєαм ѕℓα¢ĸвσт✰✯\n\nby «αzнυяα✍ ⭐👈 »»» http://line.me/ti/p/~fuck.you__ «««""",
    "lang":"JP",
    "comment":"""👉✯✰тєαм ѕℓα¢ĸвσт✰✯\n\nby «αzнυяα✍ ⭐👈 »»» http://line.me/ti/p/~fuck.you__ «««""",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
				...
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,"Galank Hadir Boss!!")
#-----------------------------------------------
...
#------------------------------------------------------------------
            ...
            elif msg.text in ["Galank glist2"]:
                if msg.from_ in owner:
                    gid = cl.getGroupIdsJoined()
                    h = ""
                    for i in gid:
            ...
            elif msg.text in ["Galank muach"]:
                if msg.from_ in owner:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "ua7fb5762d5066629323d113e1266e8ca',"}
                    cl.sendMessage(msg)
            elif msg.text in ["Galank","galank"]:
                if msg.from_ in owner:
                    cl.sendText(msg.to,"Galank masih aktif Yank...!!!")
