")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="EsSxJfKdY1S2GKWxFah4.qI2PZDEevvrDVi/jO+Tfza.ZJqnZCHw/KkGkb+K3pY0rsbyTpS6YRrC2xWRmyPswJM=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="Es9TBsTDJZQawHqcITr7.pt5ku5OvCXgXicoZ42L15W.t7+uZzOcgvQFMVL9pNB7CBs+XIOk3rOQkDGn7QEG6zA=")
kt.loginResult()

ku = LINETCR.LINE()
ku.login(token="EspQzPVeiK3H5iYsfdqb.97lTGVmvXjWrorbWSIp6wW.+qbRsB/MD06mZs2Camr17B4GU59muzwwAHC1y1Q9Odc=")
ku.loginResult()
...
KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt,ku]
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid]
admin = ["u78643d09e42a36836a17cc918963a8b7",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid]
owner = ["u78643d09e42a36836a17cc918963a8b7",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid]
wait = {
    'contact':False,
    'autoJoin':False,
    ...
    "lang":"JP",
    "comment":"Auto Like Bye line.me/ti/p/~fuck.you__",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#==================================================
			...
			ku.sendText(msg.to,Umid)
				...
				saytxt = msg.text.replace("B1 say ","")
				ki.sendText(msg.to,(saytxt))
            elif "B2 say " in msg.text:
				saytext = msg.text.replace("B2 say ","")
...
#======================================
                ...
                string = msg.text.replace("B17 rename: ","")
                if len(string.decode('utf-8')) <= 20:
...
#-----------------------------------------------
            ...
            elif msg.text in ["B1 rgroups","Y1 rgroup"]:
...
#========================================
            elif msg.text in ["Siri on","Join","เข้ามา"]:
					...
					cl.updateGroup(G)
            elif msg.text in ["B1 join","Y1 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["B2 join","Y2 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["B3 join","Y3 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["B4 join","Y4 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["B5 join","Y5 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["Pulang","pamit all","ไปใด้"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
		...
		ku.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["B1 @bye","Y1 pulang","B1 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ki.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["B2 @bye","Y2 pulang","B2 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kk.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["B3 @bye","Y3 pulang","B3 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kc.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["B4 @bye","Y4 pulang","B4 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kd.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["B5 @bye","Y5 pulang","B5 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ke.leaveGroup(msg.to)
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "Salkenall" in msg.text:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Salkenall","")
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = "u78643d09e42a36836a17cc918963a8b7","u329645b7a24610ca4d95c592a6c6ef3e","u19a6336222efe94acce1b05dd39c0940","u5951d80ddf212d25a0495c0f20da00be"
			if op.param2 in OWN:
				pass
			else:
				Inviter = op.param3.replace("",',')
